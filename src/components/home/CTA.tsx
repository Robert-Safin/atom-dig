    ...
    <div className="border-text-stroke tablet:my-[96px] laptop:my-[147px] desktop:mt-[168px] my-[86px] w-full border-y-[1px]">
      <div className="flex w-full items-center justify-center px-12">
        <div className="border-text-stroke relative border-x-[1px]">
          ...
          <div className="border-text-stroke-shine bg-background-opaque tablet:pt-[48px] tablet:pb-[60px] tablet:px-[58px] laptop:pt-[64px] laptop:pb-[92px] laptop:px-[78px] desktop:pt-[78px] desktop:pb-[124px] desktop:px-[135px] tablet:space-y-[28px] laptop:space-y-[24px] desktop:space-y-[42px] relative flex h-full w-full max-w-[1164px] flex-col space-y-[24px] overflow-hidden rounded-[32px] border-[1px] px-[17px] pt-[40px] pb-[52px]">
            {isMounted && (
              <div
                className={
                  theme === "dark"
                    ? `bg-text-stroke border-ring mx-auto w-fit rounded-[26px] border-[2px] px-[18px] py-[8px] text-center`
                    : `border-ring mx-auto w-fit rounded-[26px] border-[2px] px-[18px] py-[8px] text-center`
                }
              >
                <TextBubble text="What we do" />
              </div>
            )}

            <H1
              text="Atomic Digital is a cutting-edge hedge fund specializing in
          quantitative trading strategies for digital assets."
            />
