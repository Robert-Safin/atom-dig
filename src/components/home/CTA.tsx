    ...
    <div className="border-text-stroke tablet:my-[96px] laptop:my-[147px] desktop:mt-[168px] my-[86px] w-full border-y-[1px]">
      <div className="flex w-full items-center justify-center px-12">
        <div className="border-text-stroke relative border-x-[1px]">
          ...
          <div className="cta-shadow-dm border-text-stroke-shine bg-background-opaque tablet:pt-[48px]
           tablet:px-[58px] laptop:pt-[64px]  laptop:px-[78px] desktop:pt-[78px]
           desktop:px-[135px] tablet:space-y-[28px] laptop:space-y-[24px] desktop:space-y-[42px] relative flex h-full w-full
           max-w-[1420px] flex-col space-y-[24px] overflow-hidden rounded-[64px] border-[1px] px-[17px] pt-[40px]
           pb-[24px] tablet:pb-[48px] laptop:pb-[64px]
           ">
            {isMounted && (
              <div
                className={
