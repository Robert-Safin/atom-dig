...
const Navigation = () => {
  ...
  return (
    ...
    {isOpen && (
          <div
            className="fixed top-0 z-50 right-0  h-screen w-[243px] bg-text-alt flex flex-col pt-[12px] pr-[12px] pl-[26px]
            tablet:pt-[24px] tablet:pr-[24px] tablet:pl-[34px] laptop:hidden
            ">
            <X onClick={() => setIsOpen(false)} className="self-end w-[24px] h-[24px] tablet:w-[34px] tablet:h-[34px]"/>
            <div className="flex flex-col space-y-[24px] tablet:space-y-[32px] mt-[24px] tablet:mt-[43px]">
