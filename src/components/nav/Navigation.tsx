...
const Navigation = () => {
  ...
  return (
<nav className="tablet:px-[24px] laptop:px-[32px] laptop:mt-[36px] desktop:px-[42px] absolute top-0 left-1/2 -translate-x-1/2 mt-[18px] flex w-full max-w-[1920px] items-center justify-between px-[12px]">
